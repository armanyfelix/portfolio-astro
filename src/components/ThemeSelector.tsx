    ...
    <DialogTrigger>
      ...
      <Popover className='outline-none mt-5'>
        ...
        <Dialog className='outline-none'>
          <ul
            className={`rounded-box menu max-h-[40vh] overflow-auto bg-accent-focus bg-opacity-30 p-3 shadow-lg backdrop-blur-md backdrop-brightness-75 md:max-h-[70vh] md:w-auto`}
          >
            {themes.map((t: any) => (
              <li key={t.name}>
                <label
                  className='btn btn-square btn-ghost swap swap-rotate'
                  data-toggle-theme={t.name}
